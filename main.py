...
if V040: smokearray, df = querydata.getdata(5, 10, "registry.sagecontinuum.org/iperezx/wildfire-smoke-detection:0.5.0", "V040")
else: smokearray, df = querydata.getdata(5, 10, "registry.sagecontinuum.org/iperezx/wildfire-smoke-detection:0.7.3", "V015")
...
meta_data = postpro.drawtiles(newestRes, file_name)
print(meta_data)